...
class Create extends Component
{
    ...
    public function mount(SectionSale $sectionSale)
    {
        ...
        $this->sectionSale->todays_sales     = '0';
        $this->sectionSale->yesterdays_sales = '0';
        $this->sectionSale->weeks_sales      = '0';
        $this->sectionSale->months_sales     = '0';
        $this->sectionSale->years_sales      = '0';
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.section-sale.create');
    }
