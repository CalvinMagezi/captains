                    ...
                    <div class="auth-box card">
                        <div class="card-block">
                            <div class="row m-b-20">
                                <div class="col-md-12">
                                    <h3 class="text-center txt-primary">Edit order #{{$order->id}}</h3>
                                </div>
                            </div>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-6">                                    
                                    ...
                                    <div class="form-group form-primary">
                                        ...
                                        <input type="text" id="search" name="item_name" class="form-control search" required>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p>Add an extra item to this order</p>
                                </div>
                            </div>
                                                      
                            <div class="row m-t-30">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Add Item</button>
                                </div>
                            </div>
                        </form>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{$loop->iteration}}) {{$details->item_name}}" aria-label="" aria-describedby="basic-addon1" readonly>
