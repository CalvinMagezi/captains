                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'booked_by'])
                        </th>
                        <th>
                            {{ trans('cruds.booking.fields.booked_for') }}
                            @include('components.table.sort', ['field' => 'booked_for'])
                        </th>
                        <th>
                            {{ trans('cruds.booking.fields.table_booked') }}
                            @include('components.table.sort', ['field' => 'table_booked.table_number'])
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    ...
                                    @endcan
                                    @can('booking_delete')
                                        <button class="btn btn-sm btn-indigo mr-2" type="button" wire:click="confirm('delete', {{ $booking->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
