                ...
                <thead>
                    <tr>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'for'])
                        </th>
                        <th>
                        ...
                        <th>
                            ...
                            @include('components.table.sort', ['field' => 'completed'])
                        </th>
                        <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex justify-end">
                                    ...
                                    @endcan
                                    @can('notification_delete')
                                        <button class="btn btn-sm btn-indigo mr-2" type="button" wire:click="confirm('delete', {{ $notification->id }})" wire:loading.attr="disabled">
                                            {{ trans('global.delete') }}
                                        </button>
                                    @endcan
                                </div>
