                    ...
                    <!-- Authentication card start -->
                        ...
                        <form action="{{ route('signin') }}" method="post" class="md-float-material form-material">
                            ...
                            <div class="text-center">
                                <img style="max-width: 300px;" src="{{ asset('dash_admin/images/logo.png') }}" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="text-center btn btn-primary btn-md btn-block waves-effect waves-light m-b-20">Sign in</button>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
                                        <div class="col-md-10">
                                            <p class="text-left text-inverse m-b-0">Karibu</p>
                                            {{-- <p class="text-left text-inverse"><a href="index.html"><b>Back to website</b></a></p> --}}
                                        </div>
                                        <div class="col-md-2">
                                            <img style="max-width: 60px;" src="{{ asset('dash_admin/images/logo.png') }}" alt="small-logo.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
